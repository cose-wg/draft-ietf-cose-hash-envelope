...
When hashes are used as identifiers, hints also improve discoverability of original payload content the hashes represent.
In some applications, such as remote signing procedures, conveyance of hashes instead original payload content reduce the conveyed amount of data drastically.
